...
(() => {
    ...
    Sprite_Gauge.prototype.bitmapWidth = function() {
        if (maxColsMenuWnd === 0) {
            return 168 * 4 / $gameParty.members().length
        } else {
            return 168 * 4 / maxColsMenuWnd
        }
    }
    ...
    Sprite_Gauge.prototype.labelFontSize = function() {
        if (maxColsMenuWnd === 0) {
            return ($gameSystem.mainFontSize() - 2) * 4 / $gameParty.members().length
        } else {
            return ($gameSystem.mainFontSize() - 2) * 4 / maxColsMenuWnd
        }
    }
