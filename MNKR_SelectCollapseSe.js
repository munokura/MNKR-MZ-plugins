/*
 * --------------------------------------------------
 * MNKR_SelectCollapseSe Ver.0.0.1
...
(() => {
  ...
  Game_Enemy.prototype.performCollapse = function () {
    ...
    const file = String(this.enemy().meta.CollapseSeFile);
    if (this.collapseType() === 0 && (file !== 'undefined')) {
      let Param = [];
      if (this.enemy().meta.CollapseVPP) {
        Param = JsonEx.parse(`[${this.enemy().meta.CollapseVPP}]`);
      } else {
        Param = [90, 100, 0];
      }
